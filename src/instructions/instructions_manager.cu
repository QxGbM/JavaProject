...
void instructions_manager::changeInstsSize (const int worker_id, const int size_in)
{
...
void instructions_manager::changePointersSize (const int size_in)
{
...
void instructions_manager::loadPointers (void ** ptrs_in, const int n_ptrs, int * mapping)
{
  if (n_ptrs == 0)
  { return; }
...
int instructions_manager::loadInsts (int * tmp_size, int * rnd_size, const int worker_id, const instructions_queue * queue, const h_ops_dag * dag, void ** tmp_ptrs, const double gpu_clock_multiplier)
{
  if (queue == nullptr) 
...
instructions_manager::instructions_manager (const int num_workers, const h_ops_dag * dag, const instructions_scheduler * schedule, void ** tmp_ptrs)
{
...
cudaError_t instructions_manager::getLaunchArgs (int *** dev_insts, void *** dev_ptrs, int ** comm_space, real_t*** block_tmps, real_t ** dev_rnd_seed, const unsigned int seed_in) const
{
